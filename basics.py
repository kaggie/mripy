...
class gradient_class():
    ...
    def addrampup(self,gradx,gradmax=.2)
        gradx = np.hstack([ramp(0,gradx[0],vmax=gradmax)[0],gradx])
        return gradx
